//! Axum + Leptos host for gauge-app PermissionRoutes Playwright.
...
use axum::Router;
use gauge_uf_app_e2e::seed::seed_data;
use gauge_uf_app_e2e::{
...
async fn serve() -> anyhow::Result<()> {
    ...
    log::info!("gauge-uf-app-e2e listening on http://{addr}");
